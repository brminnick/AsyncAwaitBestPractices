...
class Tests_SafeFireAndForgetT : BaseTest
{
	...
	[Test]
	public async Task SafeFireAndForget_ExecuteAsync_ExceptionHandling_Test()
	{
		//Arrange
	...
	[Test]
	public async Task SafeFireAndForget_ExecuteAsync_ExceptionHandlingWithParameter_Test()
	{
		//Arrange
